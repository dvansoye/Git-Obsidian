...
Highlights are identified in this scenario as anything between double equals signs like ==this==. Reactions are identified as text between double forward slashes like //this//. Sometimes reactions are combined with highlights like ==highlighted text. //my reaction to highlighted text//== On rare occasions, I will use the key 🔑 emoji to denote a key highlight or a reaction. This is a ==highlighted text with a 🔑 emoji==. This is a //reaction with the 🔑 emoji//. 
...
Low - the text itself without highlights or reactions. This should be used as context for the highlights and reactions when you find them. 
Medium - Highlighted text (see identification above) 
High - Highlights with a key 🔑 emoji OR my reactions OR highlighted text with my reaction combined (see identification above) 
