...
id: proPrompt-v4
version: 4.0.0
description: Have the LLM generate relevant research questions that lead to insights that help me to reach and even transcend my goals.
required_values:
author: dvansoye
---
# User Instructions
